(function(e, t) {
	...
	function n(e) {
		...
		"function" == typeof e.animation && (e.animation = e.animation.call()),
			e.showCloseButton
				? (g.setAttribute("aria-label", e.closeButtonAriaLabel), O(g))
				: V(g),
			(t.className = k.popup),
			e.toast
				? (L(
		...
		if (e.type) {
			...
			O(E), e.animation && L(E, "swal2-animate-" + e.type + "-icon");
		}
		var S = U();
		if (
			(e.imageUrl
			...
			e.showConfirmButton || e.showCancelButton ? O(u) : V(u),
			...
			L([c, p], k.styled),
				...
				e.cancelButtonColor &&
					(p.style.backgroundColor = e.cancelButtonColor);
			var P = window
				.getComputedStyle(c)
				.getPropertyValue("background-color");
	...
	var Ae = {
		...
		Se = function(e, t, n) {
			...
			null !== t && "function" == typeof t && t(i),
				e ? (L(i, k.show), L(o, k.fade), _(i, k.hide)) : _(i, k.fade),
				O(i),
				(o.style.overflowY = "hidden"),
				ie && !E(i, k.noanimation)
					? i.addEventListener(ie, function e() {
			...
			_main: function(e) {
				...
				return new Promise(function(e, n) {
					...
					for (
						var g = function(e) {
								if (
									(o.showLoaderOnConfirm && l.showLoading(),
									o.preConfirm)
								) {
								...
								switch (i.type) {
									case "click":
										if (!(c && l.isVisible()))
											...
											(t.disableButtons(), o.input)
										) {
											var f = p();
											if (o.inputValidator) {
												t.disableInput();
												var h = Promise.resolve().then(
													function() {
														return o.inputValidator(
															f,
															o.extraParams
														);
													}
						...
						x = function(n, e) {
							...
							if ("Enter" === n.key && !n.isComposing) {
								...
								[
									...
									? ("Escape" === n.key || "Esc" === n.key) &&
									  !0 === v(e.allowEscapeKey) &&
									  d(l.DismissReason.esc)
									: document.activeElement ===
											r.confirmButton && H(r.cancelButton)
					...
					for (
						...
						if (((A = t.getInput(B[E])), A)) {
							...
							for (var M in o.inputAttributes)
								A.setAttribute(M, o.inputAttributes[M]);
						}
						(_.className = P),
							o.inputClass && L(_, o.inputClass),
							V(_);
					}
					var D;
					switch (o.input) {
						...
						case "tel":
						case "url":
							(A = T(r.content, k.input)),
								(A.value = o.inputValue),
								(A.placeholder = o.inputPlaceholder),
								(A.type = o.input),
								O(A);
							break;
						case "file":
							(A = T(r.content, k.file)),
								(A.placeholder = o.inputPlaceholder),
								(A.type = o.input),
								O(A);
							break;
						case "range":
							var R = T(r.content, k.range),
							...
							break;
						case "select":
							var W = T(r.content, k.select);
							if (((W.innerHTML = ""), o.inputPlaceholder)) {
								var U = document.createElement("option");
								(U.innerHTML = o.inputPlaceholder),
									(U.value = ""),
									(U.disabled = !0),
									(U.selected = !0),
									W.appendChild(U);
							...
							D = function(e) {
								e.forEach(function(e) {
									...
									(a.value = n),
										(a.innerHTML = i),
										o.inputValue.toString() ===
											n.toString() && (a.selected = !0),
										W.appendChild(a);
								}),
									O(W),
									W.focus();
						...
						case "radio":
							...
							break;
						case "checkbox":
							var z = T(r.content, k.checkbox),
								F = t.getInput("checkbox");
							(F.type = "checkbox"),
								(F.value = 1),
								(F.id = k.checkbox),
								(F.checked = !!o.inputValue);
							var Y = z.getElementsByTagName("span");
							Y.length && z.removeChild(Y[0]),
								(Y = document.createElement("span")),
								(Y.innerHTML = o.inputPlaceholder),
								z.appendChild(Y),
								O(z);
							break;
						case "textarea":
		...
		(function(e) {
			...
			return (
				"undefined" != typeof window &&
					"object" === a(window._swalDefaults) &&
					t.setDefaults(window._swalDefaults),
				t
			);
		})(o)
	);
